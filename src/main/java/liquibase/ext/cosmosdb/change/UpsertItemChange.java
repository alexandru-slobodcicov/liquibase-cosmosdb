...
import liquibase.ext.cosmosdb.statement.UpsertItemStatement;
import liquibase.statement.SqlStatement;
import lombok.Getter;
import lombok.NoArgsConstructor;
import lombok.Setter;

@DatabaseChange(name = "upsertItem",
        description = "Upserts a Single Document " +
                "https://docs.microsoft.com/en-us/java/api/com.azure.cosmos.cosmoscontainer.upsertitem?view=azure-java-stable\n" +
