...
class CreateItemChangeTest extends AbstractCosmosChangeTest {

    @Test
    void getConfirmationMessage() {
        assertThat(new CreateItemChange().getConfirmationMessage()).isNotNull();
    }

    @Test
    @SneakyThrows
    void generateStatements() {
        final List<ChangeSet> changeSets = getChangeSets("liquibase/ext/change.create-item.test.xml", database);
